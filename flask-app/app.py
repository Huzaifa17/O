...
def utility_processor():
    return dict(
        ...
        make_links_clickable=make_links_clickable  # Make the function available in templates
    )
...
def add_notification(notification_type, message, target_user=None, target_post=None, page=None):
    ...
    if target_post:
        ...
        if page:
            # Include the page number in the link
            notification['link'] = url_for('view_topic', post_id=str(target_post['_id']), page=page)
        else:
...
def add_comment(post_id):
    ...
    page_number = calculate_page_number(post_id, top_level_parent['timestamp'])
